...
namespace {
struct qt_meta_tag_ZN16CalculatorWindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN16CalculatorWindowE = QtMocHelpers::stringData(
    "CalculatorWindow"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN16CalculatorWindowE[] = {
...
Q_CONSTINIT const QMetaObject CalculatorWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16CalculatorWindowE.offsetsAndSizes,
    qt_meta_data_ZN16CalculatorWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16CalculatorWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *CalculatorWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16CalculatorWindowE.stringdata0))
